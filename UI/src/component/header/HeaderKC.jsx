...
class HeaderKC extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        if (logo === 'light') {
            ...
            logoUrl = <img src="/assets/images/logo/kc-logo.png" className="kc-logo" alt="Kalwanu Constructions" />;
        }
                ...
                <div className="header-wrapper" id="header-wrapper">
                    ...
                    <div className="header-right header-right-kc">
                        ...
                        <div className="header-btn">
                            ...
                            <a class="btn-transparent rn-btn-dark" href="tel:1300123456">
                                <span class="text">1800.960.101</span>
                            </a>
